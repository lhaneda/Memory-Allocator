...
(in this example, the command {\ttfamily ls /} is run with the custom memory allocator instead of the default).\hypertarget{index_autotoc_md1}{}\doxysection{Testing}\label{index_autotoc_md1}
